...
ActiveRecord::Schema.define(version: 20150627062824) do
  ...
  add_index "position_users", ["position_id"], name: "index_position_users_on_position_id"
  add_index "position_users", ["user_id"], name: "index_position_users_on_user_id"
